...
export class ExportService {
  /**
  * Export a report if governance stage allows. Returns an export artifact route.
   */
  static async exportReport(params: {
    ...
    // Export route generated by service conventions; artifact rendering is handled by downstream processors.
  ...
  static async emailReport(reportId: string) {
    ...
    // Email delivery event is recorded for downstream notification processors.
    await GovernanceService.recordProvenance({
      reportId,
      artifact: 'report-export',
