...
**Outputs you see:**
- confidence grade,
- proceed/pause/re-structure recommendation,
- explicit rationale.

---

## 4) The 16 derivative indices (specialist formulas)
...
1. **Intake**: mission, constraints, region, partners, and risk appetite are structured.
2. **Validation**: NSIL checks for contradictions and weak assumptions.
3. **Debate**: five personas argue and attach evidence.
4. **Scoring**: the 21-formula suite produces scores, grades, drivers, pressure points.
5. **Synthesis**: scores + debate become recommendations, scenarios, and narratives.
6. **Delivery**: output is generated as decision-ready deliverables with traceable rationale.

---

## 6) Glossary (short)
- **Driver:** a factor that increases a score.
- **Pressure point:** a factor that reduces a score or increases risk.
