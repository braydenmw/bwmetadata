...
7. **Delivery**: output is generated as decision-ready deliverables with traceable rationale, with confidence calibrated by how long the underlying patterns have persisted.
...
## 8) The knowledge architecture: two new services

Two services implement the foundational principle at the code level:
