                    ...
                    <div className="lg:col-span-7">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="p-5 bg-white/70 border border-black/5 rounded-xl">
                                    ...
                                    <div className="text-sm text-slate-700 leading-relaxed">
                                        Partner Discovery, Symbiotic Matchmaking (SPI), Document Suite (LoI, MoU, Proposal), Multi‑Scenario Simulation.
                                    </div>
                                </div>
                                <div className="p-5 bg-white/70 border border-black/5 rounded-xl">
                                    <div className="text-[10px] font-bold uppercase tracking-[0.3em] text-bw-navy/60 mb-2">Always-On Guardrails</div>
                                    <div className="text-sm text-slate-700 leading-relaxed">
                                        Early‑Warning Alerts, Due Diligence Intelligence, Relocation & TCO, NSIL/API Export.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-3 pt-2">
                                ...
                                <span className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-bw-navy text-white rounded-full border border-bw-navy/20 text-[11px] font-bold uppercase tracking-widest">
                                    <AlertTriangle className="w-3.5 h-3.5 text-bw-gold" aria-hidden="true" /> Early‑Warning
                                </span>
                            </div>
                        </motion.div>
                    </div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="mt-5 grid grid-cols-2 gap-4">
                                            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                                                ...
                                                <div className="mt-1 text-sm text-white/90">Local reality → Global metrics</div>
                                            </div>
                                            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
