...
I can help you with:
â€¢ **Strategic Analysis** - Deep reasoning on partnerships, markets, and risks
â€¢ **Document Generation** - Create 200+ document types instantly
â€¢ **Partner Matching** - Find ideal partners using our SEAMâ„¢ engine
â€¢ **Market Intelligence** - Real-time data on 190+ countries
â€¢ **Risk Assessment** - Multi-perspective adversarial analysis
...
${currentContext?.organizationName ? `I see you're working on **${currentContext.organizationName}**. How can I help advance your strategy?` : 'What would you like to explore today?'}`,
  ...
  const generateProactiveSuggestion = useCallback(() => {
    ...
    const proactiveMessage: ChatMessage = {
      ...
      role: 'assistant',
      content: `ðŸ’¡ **Proactive Insight**: Based on your current session data, I've identified a potential optimization opportunity. Would you like me to elaborate?`,
      timestamp: new Date(),
      confidence: 85,
      ...
      >
        ...
        <div className="p-4 border-t border-slate-700 bg-slate-850">
          ...
          <p className="text-xs text-slate-600 mt-2 text-center">
            Powered by NSIL Brain â€¢ {autonomousMode ? 'Autonomous Mode Active' : 'Manual Mode'}
          </p>
        </div>
      </motion.div>
    </AnimatePresence>
