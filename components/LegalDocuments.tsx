...
const DocumentModal: React.FC<DocumentModalProps> = ({ activeDocument, onClose }) => {
    ...
    const getTitle = () => {
        switch (activeDocument) {
            case 'user-manual': return 'BWGA Intelligence AI — User Manual';
            ...
            <div className="relative w-full max-w-4xl my-8 mx-4" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
                    ...
                    <div className="border-t border-slate-200 px-8 py-4 bg-slate-50 flex items-center justify-between">
                        <p className="text-[10px] text-slate-400">© 2026 BW Global Advisory. All rights reserved. | ABN 55 978 113 300 | Melbourne, Australia</p>
...
const UserManualContent: React.FC = () => (
    <div className="space-y-8">
        ...
        <div className="text-center border-b border-slate-200 pb-8">
            ...
            <h1 className="text-3xl font-light text-slate-900 mb-2">BWGA Intelligence AI</h1>
        ...
        <div>
            ...
            <p className="mb-3">Thank you for choosing BWGA Intelligence AI. This manual will guide you through every feature of the platform, from your first search to exporting board-ready documents.</p>
            <p className="mb-3"><strong>What is BWGA Intelligence AI?</strong> It is a Sovereign-Grade Intelligence Operating System designed to help regional communities, businesses, government agencies, and first-time exporters produce institutional-quality strategic analysis — the same calibre of work that multinational corporations commission from top-tier consulting firms.</p>
        ...
        <div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
                <table className="w-full text-xs">
                    ...
                    <tbody>
                        <tr className="border-b border-slate-100"><td className="py-1.5 text-emerald-700 font-bold">≥ 80</td><td>Grade A</td><td>Investment Ready</td></tr>
                        <tr className="border-b border-slate-100"><td className="py-1.5 text-emerald-600 font-bold">≥ 70</td><td>Grade B</td><td>Investment Ready</td></tr>
                        <tr className="border-b border-slate-100"><td className="py-1.5 text-amber-600 font-bold">≥ 60</td><td>Grade C</td><td>Proceed With Caution</td></tr>
        ...
        <div>
            ...
            <div className="space-y-3">
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
                    ...
                    <p className="text-xs text-slate-600">Ensure you have a stable internet connection. Reports require multiple AI service calls. On slower connections, generation may take 30–60 seconds. If stalled beyond 2 minutes, refresh the page and try again — your intake data is preserved in local storage.</p>
                </div>
                <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
        ...
        <div className="text-center border-t border-slate-200 pt-6">
            <p className="text-xs text-slate-400">— End of User Manual —</p>
            <p className="text-xs text-slate-400">BWGA Intelligence AI · Nexus Intelligence OS v6.0 · NSIL Engine v3.2</p>
        </div>
    </div>
);
...
const TermsContent: React.FC = () => (
    <div className="space-y-6">
        ...
        <p>These Terms & Conditions ("Terms") govern your access to and use of the BWGA Intelligence AI platform ("Platform"), operated by BW Global Advisory, trading as a registered Australian sole trader under ABN 55 978 113 300 ("BWGA", "we", "us", "our").</p>
        ...
        <p>1.1. BWGA Intelligence AI is a strategic decision-support platform currently in active Research & Development (R&D). The Platform is developed in Melbourne, Australia, with development operations also conducted in Manila, Philippines.</p>
        ...
        <p>4.2. The following are proprietary indices created by BWGA: SPI™, RROI™, SEAM™, PVI™, RRI™, and all other named indices listed in the Platform's architecture documentation.</p>
        ...
        <div className="text-center border-t border-slate-200 pt-4 mt-4">
            <p className="text-xs text-slate-400">— End of Terms & Conditions —</p>
        </div>
    </div>
);
...
const PrivacyContent: React.FC = () => (
    <div className="space-y-6">
        ...
        <p>This Privacy Policy explains how BW Global Advisory (ABN 55 978 113 300) ("BWGA", "we", "us", "our") collects, uses, stores, and protects your personal information when you use the BWGA Intelligence AI platform ("Platform").</p>
        ...
        <div className="text-center border-t border-slate-200 pt-4 mt-4">
            <p className="text-xs text-slate-400">— End of Privacy Policy —</p>
        </div>
    </div>
);
...
const EthicsContent: React.FC = () => (
    <div className="space-y-6">
        ...
        <p>This Ethical AI Framework sets out the principles, safeguards, and governance structures that guide the design, development, and deployment of BWGA Intelligence AI. It reflects our commitment to responsible AI practices aligned with international standards.</p>

        <h4 className="font-bold text-slate-900 mt-6">1. Our AI Ethics Principles</h4>
        <p>BWGA Intelligence AI is built on six core ethical principles:</p>
        ...
        <p>Under the EU AI Act risk classification framework, BWGA Intelligence AI would be classified as a <strong>limited-risk</strong> system. It does not:</p>
        <ul className="list-disc ml-6 space-y-1">
        ...
        <div className="text-center border-t border-slate-200 pt-4 mt-4">
            <p className="text-xs text-slate-400">— End of Ethical AI Framework —</p>
        </div>
    </div>
);
