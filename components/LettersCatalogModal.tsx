    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-3xl bg-white rounded-sm shadow-2xl border border-stone-200">
        <div className="p-4 border-b border-stone-200 flex items-center justify-between">
          <h3 className="text-sm font-bold text-stone-900">Letters & Documents â€” Full Library</h3>
        ...
        <div className="p-6 max-h-[60vh] overflow-y-auto text-sm text-stone-700 space-y-4">
          <p className="text-stone-600">Browse a representative selection of letters and document templates. These bind to your live model to generate productionâ€‘ready drafts in seconds.</p>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="rounded-sm border border-stone-200 p-4 bg-stone-50">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Engagement Followâ€‘ups (Reminder / Scheduling / Clarification)</li>
            ...
            <div className="rounded-sm border border-stone-200 p-4 bg-stone-50">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Nonâ€‘Disclosure Agreement (NDA)</li>
                <li>Term Sheet</li>
              </ul>
            </div>
            <div className="rounded-sm border border-stone-200 p-4 bg-stone-50">
          ...
          <p className="text-xs text-stone-600">For a sectorâ€‘specific catalog and letter templates, open the Category Index or contact BW Consultant support.</p>
        </div>
      </div>
    </div>
  );
