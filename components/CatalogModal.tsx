    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-3xl bg-white rounded-sm shadow-2xl border border-stone-200">
        ...
        <div className="p-6 max-h-[60vh] overflow-y-auto text-sm text-stone-700 space-y-4">
          <p className="text-stone-600">This catalog is illustrative and tailored per sector. It lists representative outputs across 24+ categories. Request a sector‑specific pack for a precise listing.</p>
          ...
          <p className="text-xs text-stone-600">For the full sector‑specific catalog and letter templates, contact BW Consultant support.</p>
        </div>
      </div>
    </div>
  );
