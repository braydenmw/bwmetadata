    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-3xl bg-white rounded-sm shadow-2xl border border-stone-200">
        <div className="p-4 border-b border-stone-200 flex items-center justify-between">
          <h3 className="text-sm font-bold text-stone-900">Full Catalog â€” Documents & Templates</h3>
        ...
        <div className="p-6 max-h-[60vh] overflow-y-auto text-sm text-stone-700 space-y-4">
          <p className="text-stone-600">This catalog is illustrative and tailored per sector. It lists representative outputs across 24+ categories. Request a sectorâ€‘specific pack for a precise listing.</p>
          ...
          <p className="text-xs text-stone-600">For the full sectorâ€‘specific catalog and letter templates, contact BW Consultant support.</p>
        </div>
      </div>
    </div>
  );
