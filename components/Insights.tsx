...
const steps = [
  ...
  { 
      ...
      desc: 'Composite Score Engine v2 + IVAS™ + SPI™ + SCF compute readiness, velocity, and impact. We find "Asymmetry"—high value, low visibility—and quantify the gap between market perception and actual potential.' 
  },
  { 
      id: '04',
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
            <div className="lg:col-span-4">
                ...
                <p className="text-gray-600 mb-6 leading-[1.85]">
                    It is not a static database; it is an active simulation environment. Autonomous agents model how your strategy collides with real‑world friction before capital moves, then feed those learnings back into the Core.
                </p>
                <p className="text-gray-600 mb-6 leading-[1.85]">
                    The result: <strong>evidence‑anchored reasoning</strong>, real-time <strong>governance guardrails</strong>, <strong>counterfactuals</strong>, and <strong>early-warning alerts</strong> mapped directly to your mission.
                </p>
